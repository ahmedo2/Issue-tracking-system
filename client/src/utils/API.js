...
export default {
  ...
  getUser: function () {
    return axios({
      ...
      headers: {
        "x-auth-token":
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjVlODk2YTQ5MjI5YmUwODVjOGYwYjYyZSIsImlhdCI6MTU4NjA2NjYwMiwiZXhwIjoxNTg2MDcwMjAyfQ.iTb5EIMBm3aFX-p2K36eBidC3MMIyZoeEpPp42DMbOU",
      },
    });
  },
  getTickets: function () {
