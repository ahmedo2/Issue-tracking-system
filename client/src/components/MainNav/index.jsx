      ...
      {user.role === "resident" ? (
        ...
        >
          ...
          <Collapse isOpen={isOpen} navbar>
            <Nav className="mr-auto" navbar>
              <NavItem>
                <Link className="nav-link" to="/user/ticketrequest">
                  Submit Ticket
                </Link>
              </NavItem>
              <NavItem>
            ...
            <Span className="nav-text">
              <Link className="nav-link nav-brand-text" to="/user/dashboard">
                User Dashboard
              </Link>
            </Span>
            <Span className="nav-text">
              <Logout className="nav-link nav-brand-text" />
            </Span>
          </Collapse>
        </Navbar>
      ) : (
        ...
        >
          ...
          <Collapse isOpen={isOpen} navbar>
            <Nav className="mr-auto" navbar>
              <NavItem>
                <Link className="nav-link" to="/admin/ticketrequest">
                  Submit Ticket
                </Link>
              </NavItem>
              <NavItem>
                <Link className="nav-link" to="/admin/ticketlist">
                  Ticket Status
                </Link>
              </NavItem>
              <NavItem>
